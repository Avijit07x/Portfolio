...
const ProjectCard = ({ project }) => {
	return (
		<div className="animate-fadeInAndSlideLeft mx-auto mt-10 flex w-full translate-x-24 flex-col items-center justify-between gap-3 rounded-lg bg-white p-5 opacity-0 shadow-lg lg:h-[350px] lg:w-4/5 lg:flex-row lg:p-14">
